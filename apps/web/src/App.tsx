  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <main className="max-w-7xl mx-auto px-4 sm:px-5 py-6 sm:py-8 space-y-5 sm:space-y-6">
        ...
        {/* Main grid — wide left, narrow right */}
        <div className="grid grid-cols-1 lg:grid-cols-[1.7fr_0.8fr] gap-5 sm:gap-6">
          ...
          <div className="space-y-5 sm:space-y-6 min-w-0">
            ...
            <Card className="rounded-2xl border-orange-400/20 bg-gradient-to-br from-slate-900 via-slate-900 to-orange-950/20">
              <CardHeader className="pb-3">
                <CardTitle className="text-slate-50 text-sm font-semibold uppercase tracking-[0.15em]">
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <Card className="rounded-2xl border-fuchsia-400/20 bg-gradient-to-br from-slate-900 via-slate-900 to-fuchsia-950/20">
              <CardHeader className="pb-3">
                <CardTitle className="text-slate-50 text-sm font-semibold uppercase tracking-[0.15em]">
